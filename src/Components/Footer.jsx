...
const Footer = () => {
    return (
        <div className='bg-[#101727] lg:pt-30 pt-15'>
            ...
            <div className="bootmSection px-5 lg:px-0 text-white flex justify-between">
                <p className="text-base opacity-40">© 2026 Digitools. All rights reserved.</p>
